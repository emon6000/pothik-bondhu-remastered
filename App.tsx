    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col font-sans text-slate-900 dark:text-slate-100 relative transition-colors duration-300">
            ...
            <div className="space-y-4">
                ...
                <div className="flex flex-col sm:flex-row justify-center items-center space-y-3 sm:space-y-0 sm:space-x-8 mt-4">
                    <a href="mailto:contact@pothikbondhu.com" className="group flex items-center text-slate-500 hover:text-indigo-600 dark:text-slate-400 dark:hover:text-indigo-400 transition-colors bg-white dark:bg-slate-900 px-4 py-2 rounded-full border border-slate-200 dark:border-slate-800 hover:border-indigo-300 dark:hover:border-indigo-700 shadow-sm">
                        ...
                        <span>contact@pothikbondhu.com</span>
                    </a>
                    <a href="https://github.com/abdullah-al-mahmud-emon" target="_blank" rel="noopener noreferrer" className="group flex items-center text-slate-500 hover:text-indigo-600 dark:text-slate-400 dark:hover:text-indigo-400 transition-colors bg-white dark:bg-slate-900 px-4 py-2 rounded-full border border-slate-200 dark:border-slate-800 hover:border-indigo-300 dark:hover:border-indigo-700 shadow-sm">
      ...
      >
        <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
          {language === 'en' ? (
              <>
              <strong>Pothik-bondhu</strong> (Traveller's Friend) is an intelligent route planning application designed specifically for exploring the beautiful country of Bangladesh.
              </>
          ) : (
              <>
